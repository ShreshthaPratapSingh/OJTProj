      ...
      <nav>
        <div className='w-screen bg-[#111727] text-white p-2 flex items-center justify-between border-b border-y-gray-700'>
          ...
          <div className='flex items-center gap-2'>
            <button className='bg-white text-black rounded px-2 hover:cursor-pointer h-7 transition-all duration-200 font-semibold hover:-translate-y-0.5 hover:shadow-[0px_10px_10px_black]' onClick={()=>setOpenModel(true)}>+ Add Transactions</button>
