    ...
    <div className="bg-[#0d0d0d] border border-gray-700 rounded-2xl p-6 text-white w-full">
      ...
      <div className="flex items-center justify-between py-4 border-b border-gray-700">
        <div>
          ...
          <p className="text-sm text-gray-400">Download all your transaction data as CSV</p>
        </div>
        <button className="flex items-center gap-2 px-4 py-2 bg-[#1e1e1e] border border-gray-600 rounded-lg hover:bg-[#2a2a2a]">
          <Download size={15}/>
          Export
        </button>
      </div>
